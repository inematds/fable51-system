// Biblioteca de templates do curso "Fable 5.1 na prática" — formato INEMA v2
// Gera HTML self-contained (Tailwind CDN + learn.css/learn.js por caminho relativo).

export const COURSE_ID = 'fable51';
export const COURSE_TITLE = 'Fable 5.1 na prática';
export const COURSE_SUB = 'O que mudou, como usar, como gastar menos';
export const LOGO = '⚡';
export const SOURCE_OFFICIAL = 'https://platform.claude.com/docs/en/release-notes/system-prompts/claude-fable-5-1';
export const SOURCE_INDEX = 'https://platform.claude.com/docs/en/release-notes/system-prompts/overview';
export const SOURCE_DUMP = 'https://github.com/elder-plinius/CL4R1T4S/tree/main/ANTHROPIC';
export const SOURCE_PRODUCT = 'https://www.anthropic.com/claude/fable';

export const TRACKS = [
  { n: 1, slug: 'trilha1', color: 'emerald', hex: '#10b981', hexLight: '#34d399', hexPale: '#a7f3d0', hexDeep: '#064e3b', emoji: '🔍', title: 'O que mudou', short: 'O que mudou', desc: 'Entender a mudança sem hype: o que é oficial, o que é extração, o que os números dizem e o que não dizem.' },
  { n: 2, slug: 'trilha2', color: 'blue', hex: '#3b82f6', hexLight: '#60a5fa', hexPale: '#bfdbfe', hexDeep: '#1e3a8a', emoji: '🛠️', title: 'Na prática', short: 'Na prática', desc: 'Rodar os cinco testes na sua própria conta, escrever prompts do jeito novo e registrar o que viu.' },
  { n: 3, slug: 'trilha3', color: 'purple', hex: '#a855f7', hexLight: '#c084fc', hexPale: '#e9d5ff', hexDeep: '#3b0764', emoji: '💰', title: 'Gastar menos', short: 'Gastar menos', desc: 'Por token o Fable custa mais. A economia só existe em custo por tarefa concluída. Como medir e onde o barato ganha.' },
];
      ...
      <div class="flex justify-between items-center h-14">
        <div class="flex items-center space-x-3">
          <a href="${rel}/index.html" class="flex items-center space-x-2 text-yellow-400 hover:text-yellow-300">
            ...
            <span class="font-bold text-lg hidden md:inline">Fable 5.1</span>
          </a>
...
export function footer({ trackLabel = '' }) {
  ...
  <footer class="border-t border-dark-600 mt-16 py-8">
    <div class="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 text-center text-neutral-500 text-sm space-y-2">
      ...
      <p class="text-xs">Fonte do prompt de sistema: <a href="${SOURCE_OFFICIAL}" target="_blank" class="text-sky-400 hover:text-sky-300">prompt oficial publicado pela Anthropic</a> ·
        <a href="${SOURCE_DUMP}" target="_blank" class="text-sky-400 hover:text-sky-300">extração pública do runtime completo</a> (não autenticada; congelada em 02/09/2026).</p>
    </div>
  </footer>
`;
}
